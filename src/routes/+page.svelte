...
<header class="relative p-8 min-h-96 text-center bg-gradient-to-t from-lime-500 to-emerald-400 flex flex-col items-center justify-center overflow-hidden">
  ...
  <div class="text-white relative z-10 my-24">
    <h1 on:click={toggleHeaderBg} class="cursor-pointer text-8xl font-bold mb-8">Slushies</h1>
    ...
    <div class="mt-24 grid grid-cols-2 gap-6">
...
<main class="max-w-5xl mx-auto px-24 py-24 bg-white">
  ...
  <section class="pt-8 mb-24 max-w-3xl mx-auto" id="requirements">
  ...
  <section class="pt-8 mb-24 max-w-3xl mx-auto" id="faq">
