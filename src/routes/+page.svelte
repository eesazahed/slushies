...
<main class="max-w-5xl mx-auto px-6 py-12">
  <header class="mb-16 text-center">
    ...
    <h2 class="text-2xl font-bold mb-4">A Flask YSWS</h2>
    <p class="text-lg max-w-3xl mx-auto">Build something really cool with Flask, ship your project, and get rewarded!</p>
  </header>
  ...
  <section class="mb-16 text-center">
    <h2 class="text-3xl font-semibold mb-6">YSWS Programs</h2>
    <p class="max-w-xl mx-auto mb-6 text-base">
      Slushies is one of the many active YSWS programs where you build cool projects and get awesome rewards!
    </p>
    <a href="https://ysws.hackclub.com/" target="_blank" rel="noopener noreferrer"
       class="inline-block px-6 py-3 border rounded hover:bg-gray-100 transition">
      Explore Programs →
    </a>
  </section>

  <section class="mb-20 max-w-3xl mx-auto">
    <h2 class="text-3xl font-semibold mb-6 border-b pb-2">Requirements</h2>
    <ul class="list-disc list-inside space-y-3 text-base">
      ...
      <li>Talk about your project in a README.md file and include some screenshots</li>
  ...
  <section class="mb-24 max-w-3xl mx-auto">
